...
export const pushCreateQuestion1 = createRequestBound('CREATE_QUESTION_PUSH');
export const saveCreateQuestionField = createTriggerBound(
  'CREATE_QUESTION_FIELD_SAVE'
);
